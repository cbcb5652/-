...
![image-20200727162538957](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727162538957.png)

某些场景下二叉树有弊端，所以Mysql使用的是B+ 树来做索引

> 当索引为以下的情况时建立索引并不会加速查询速度

![image-20200727162933507](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727162933507.png)
...
![image-20200727164754263](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727164754263.png)
...
![image-20200727165320947](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727165320947.png)
...
![image-20200727171028634](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727171028634.png)
...
![image-20200727171753781](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727171753781.png)
...
![image-20200727215208262](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727215208262.png)

> **栈**：放局部变量（线程栈）-> 放自己局部变量的内存区域。
>
> ​			当调用到方法的时候，会给对应的方法分配栈帧。分配专属的内存区域。放自己方法内部的局部变量

![image-20200727223457179](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727223457179.png)
...
![image-20200727224740722](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727224740722.png)
...
![image-20200727233406163](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727233406163.png)
...
![image-20200727235508033](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200727235508033.png)
...
![image-20200728000852391](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728000852391.png)

> 只要数据开启了总线监听机制(**MESI缓存一致性协议**)：各个线程会监听着总线的变化，当对应的值做出了修改，总线中会将对应的线程中的工作内存的值给**失效掉**。下次调用失效的值的时候，会**再次区主内存中取值**。

![image-20200728001952821](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728001952821.png)
...
![image-20200728003757917](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728003757917.png)
...
![image-20200728165826072](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728165826072.png)

![image-20200728165838479](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728165838479.png)
...
![image-20200728171936114](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728171936114.png)
...
![image-20200728223736628](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728223736628.png)

2. @Import(value={TulingImportBeanDefinitionRegister.class})  实现了TulingImportBeanDefinitionRegister接口

![image-20200728223946181](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728223946181.png)

3. @Import(value={TulingImportSelector.class})    (可以导入多个)

![image-20200728224121481](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728224121481.png)
...
![image-20200728230435894](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200728230435894.png)
...
![image-20200729000439722](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729000439722.png)
...
![image-20200729152735446](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729152735446.png)
...
![image-20200729153634401](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729153634401.png)
...
![image-20200729161711409](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729161711409.png)

> JDK8之后不会死锁

4个指针：  在一个链表上切割出50%   50% 减少，两个指针交换的顺序 (分割成两部分)

![image-20200729163718580](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729163718580.png)

切割之后，避免了体位的转换，避免了死锁

![image-20200729163839378](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729163839378.png)
...
![image-20200729172802355](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729172802355.png)
...
![image-20200729175254278](C:\Users\晨边\AppData\Roaming\Typora\typora-user-images\image-20200729175254278.png)
